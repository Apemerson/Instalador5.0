...
system_mv_folder() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do Sistema...${GRAY_LIGHT}"
  printf "\n\n"
...
system_unzip_whaticket() {
  print_banner
  printf "${WHITE} 💻 Descompactando o sistema...${GRAY_LIGHT}"
  printf "\n\n"
...
system_puppeteer_dependencies() {
  print_banner
  printf "${WHITE} 💻 Instalando Dependências puppeteer...${GRAY_LIGHT}"
  printf "\n\n"
