...
frontend_node_dependencies() {
  ...
  npm install react-quill quill-emoji --force
  npm install emoji-picker-react --force
  npm install @material-ui/core.ListItemText --force
  npm install react-apexcharts apexcharts --force
  npm install react-gauge-chart --force
  npm install echarts-for-react --force 
